      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <h5 class="card-title text-center" style="font-size: 20px">계정이 없으신가요? <a href="<c:url value="/member/regist" />"> 가입하기</a></h6>
            <form class="form-signin" method="post">
              <div class="form-label-group">
                <input type="email" id="inputEmail" class="form-control" placeholder="Email address" name="uId" required autofocus>
